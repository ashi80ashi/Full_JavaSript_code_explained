  //  DOM :document object model -> it means the whole html document is treated as object
  // if you want to see then check console.log(document)
  // by help of DOM  we can access any element of HTML document 
  

  //console.log(document); //you can see whole html doc. in console

  //console.log(document.body);  //you can see body part of your html doc. inside the console

  //console.log(document.body.firstChild); //it will access the first child i.e(the text between body tag and h1 tag)
